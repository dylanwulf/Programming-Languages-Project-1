...
2) Select "ADA (Gnat x.x.x)" from the dropdown box
3) Paste the nofiveweekends.adb code into the text editor
...
- First implementation: Since it is only possible to have 5 weekends in a 31-day month beginning on a Friday,
  ...
  within the specified date range to determine which years have (and do not have) 5 weekends.
  
Functions:
- whichDayOfWeek - calculates which day of the week a given day is
